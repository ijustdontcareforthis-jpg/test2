    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3 w-full sm:w-auto">
          <button className="px-4 py-2 text-gray-600 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 w-full sm:w-auto">
            Export
          </button>
        ...
        <div className="xl:col-span-2 bg-white p-4 sm:p-6 rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={index} className="flex items-start sm:items-center space-x-3 sm:space-x-4 p-3 hover:bg-gray-50 rounded-lg">
